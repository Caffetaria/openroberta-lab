...
public class ListsSetIndexTest extends Ev3LejosAstTest {
    ...
    public void Test() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/lists/lists_set_index.xml", new Ev3JavaGeneratorWorker());
    }
    ...
    public void Test1() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/lists/lists_set_index1.xml", new Ev3JavaGeneratorWorker());
    }
    ...
    public void Test2() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/lists/lists_set_index2.xml", new Ev3JavaGeneratorWorker());
    }
}

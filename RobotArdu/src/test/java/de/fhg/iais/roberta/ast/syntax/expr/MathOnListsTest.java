...
public class MathOnListsTest extends ArduinoAstTest {
    ...
    public void mathOnListSum() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/math/math_on_list_sum.xml", new ArduinoCxxGeneratorWorker());
    }
    ...
    public void mathOnListMin() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/math/math_on_list_min.xml", new ArduinoCxxGeneratorWorker());
    }
    ...
    public void mathOnListMax() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/math/math_on_list_max.xml", new ArduinoCxxGeneratorWorker());
    }
    ...
    public void mathOnListAverage() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/math/math_on_list_average.xml", new ArduinoCxxGeneratorWorker());
    }
    ...
    public void mathOnListMedian() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/math/math_on_list_median.xml", new ArduinoCxxGeneratorWorker());
    }
    ...
    public void mathOnListStandardDeviation() throws Exception {
        ...
        UnitTestHelper.checkWorkers(testFactory, a, "/syntax/math/math_on_list_std_dev.xml", new ArduinoCxxGeneratorWorker());
    }

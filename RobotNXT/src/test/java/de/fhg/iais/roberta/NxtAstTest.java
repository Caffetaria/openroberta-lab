...
public class NxtAstTest extends AstTest {
    ...
    public static void setup() {
        ...
        Map<String, String> motorBLproperties = createMap("MOTOR_REGULATION", "TRUE",
                                                          "MOTOR_REVERSE", "OFF", "MOTOR_DRIVE",
                                                          "LEFT");
        ConfigurationComponent motorBL = new ConfigurationComponent("LARGE", true, "B", "B",
                                                                    motorBLproperties);

        Map<String, String> motorCproperties = createMap("MOTOR_REGULATION", "TRUE",
                                                         "MOTOR_REVERSE", "OFF", "MOTOR_DRIVE",
                                                         "RIGHT");
        ConfigurationComponent motorC = new ConfigurationComponent("LARGE", true, "C", "C",
                                                                   motorCproperties);

        ConfigurationComponent sensorS1 = new ConfigurationComponent("TOUCH", true, "S1", "1", Collections
                .emptyMap());
        ...
        ConfigurationComponent sensorUS2 = new ConfigurationComponent("ULTRASONIC", true, "S2", "2",
                                                                    Collections.emptyMap());
        ConfigurationComponent sensorUS4 = new ConfigurationComponent("ULTRASONIC", true, "S4", "4",
                                                                      Collections.emptyMap());
        ...
        builderBC.setTrackWidth(11f)
                 .setWheelDiameter(5.6f)
                 .addComponents(Arrays.asList(motorBL,
                                              motorC,
                                              sensorS1,
                                              sensorS2,
                                              sensorS3,
        ...
        builderAC.setTrackWidth(11f)
                 .setWheelDiameter(5.6f)
                 .addComponents(Arrays.asList(motorA,
                                              motorC,
                                              sensorS1,
                                              sensorS2,
                                              sensorS3,
        ...
        builderUS2US4.setTrackWidth(11f)
                 .setWheelDiameter(5.6f)
                 .addComponents(Arrays.asList(sensorUS2,
                                              sensorUS4));
